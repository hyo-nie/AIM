...
<!DOCTYPE html>
	...
	<div id="header_section" class="header ty3">
		...
		<div id="nav" class="area__gnbmovingbar">
			<ul>
				<li class=""><a
					href="./Ticketing.tk">예매</a>
					<!-- 예매 임시 가상주소 입니다 자유롭게 변경해서 사용해주세요 -->
					<div>
						<ul>
				...
				<li class=""><a
					href="./MovieList.mv">영화</a>
					<!-- 영화 임시 가상주소 입니다 자유롭게 변경해서 사용해주세요 -->
					<div>
						<ul>
				...
				<li class="">
					<a href="">영화관</a>
					<!-- 영화관은 상세영화관 클릭안하면 클릭해도 이동 없습니다 자유롭게 변경해서 사용해주세요 -->
					<div>
						<ul>
				...
				<li class="">
					...
					<!-- 스토어 임시 가상주소 입니다 자유롭게 변경해서 사용해주세요 -->
					<div>
						<ul>
